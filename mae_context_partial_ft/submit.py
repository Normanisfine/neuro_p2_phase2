"""
MAE Context Partial FT — submission
"""
...
def load_checkpoint(checkpoint_path, device):
    ...
    if os.path.exists(config_path):
        ...
        position_blend = cfg.get("position_blend", 0.8)
    else:
        model = ContextConditionedMAEDecoder()
...
def main():
    ...
    parser.add_argument("--output", type=str, default="submission_mae_context.csv")
    parser.add_argument("--max-seq-len", type=int, default=None)
    parser.add_argument("--stride", type=int, default=None)
    parser.add_argument("--position-blend", type=float, default=None)
    parser.add_argument("--phase1-checkpoint", type=str, default=DEFAULT_PRETRAINED, help="for reference only; submit loads Phase 2 checkpoint")
    ...
    print(f"Inference config: max_seq_len={max_seq_len}, stride={stride}, position_blend={position_blend:.3f}")
