"""
Transformer Multitask Scratch — submission
"""
...
from train import MAX_SEQ_LEN, TransformerMultitaskDecoder, predict_session_positions  # noqa: E402
...
def load_checkpoint(checkpoint_path, device):
    ...
    if os.path.exists(config_path):
        ...
        position_blend = cfg.get("position_blend", 0.7)
    else:
        model = TransformerMultitaskDecoder()
...
def main():
    ...
    parser.add_argument("--output", type=str, default="submission_scratch_multitask.csv")
